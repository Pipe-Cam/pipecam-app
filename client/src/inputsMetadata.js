...
export const accessDetails = {
    ...
    initial_pipe_material: {input_type: 'radio', name: 'initial_pipe_material', id: 'initial_pipe_material_checkbox_input', placeholder: 'Initial Pipe Material', value_datatype: 'string', value_choices: ['ci','abs','vcp','pvc','orbg','hdpe','cipp','dip'], depends_on_id: '', has_children: false, display: 'inherit'},
